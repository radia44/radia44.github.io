console.log("### p5.collide v0.7.3 ###"),p5.prototype._collideDebug=!1,p5.prototype.collideDebug=function(t){
  _collideDebug=t;
  ...
  let c=r,p=l;return r<t?c=t:r>t+e&&(c=t+e),l<o?p=o:l>o+i&&(p=o+i),this.dist(r,l,c,p)<=n/2;
  ...
  let n=r/2,c=l/2;if(t>e+n||t<e-n||o>i+c||o<i-c){
    return!1;
  }let p=t-e,y=o-i,d=c*this.sqrt(this.abs(n*n-p*p))/n;return y<=d&&y>=-d;
  ...
  let c=this.dist(t,o,e,i),p=this.dist(t,o,r,l),y=this.dist(e,i,r,l);return void 0===n&&(n=0.1),c+p>=y-n&&c+p<=y+n;
  ...
  let c=this.collidePointCircle(t,o,r,l,n),p=this.collidePointCircle(e,i,r,l,n);if(c||p){
    return!0;
  }let y=t-e,d=o-i,u=this.sqrt(y*y+d*d),s=((r-t)*(e-t)+(l-o)*(i-o))/this.pow(u,2),x=t+s*(e-t),f=o+s*(i-o);return!!this.collidePointLine(x,f,t,o,e,i)&&(this._collideDebug&&this.ellipse(x,f,10,10),y=x-r,d=f-l,this.sqrt(y*y+d*d)<=n/2);
  ...
  let y=((n-r)*(o-l)-(c-l)*(t-r))/((c-l)*(e-t)-(n-r)*(i-o)),d=((e-t)*(o-l)-(i-o)*(t-r))/((c-l)*(e-t)-(n-r)*(i-o));if(y>=0&&y<=1&&d>=0&&d<=1){
  ...
  let y,d,u,s,x;return p?x={left:y=this.collideLineLine(t,o,e,i,r,l,r,l+c,!0),right:d=this.collideLineLine(t,o,e,i,r+n,l,r+n,l+c,!0),top:u=this.collideLineLine(t,o,e,i,r,l,r+n,l,!0),bottom:s=this.collideLineLine(t,o,e,i,r,l+c,r+n,l+c,!0)}:(y=this.collideLineLine(t,o,e,i,r,l,r,l+c),d=this.collideLineLine(t,o,e,i,r+n,l,r+n,l+c),u=this.collideLineLine(t,o,e,i,r,l,r+n,l),s=this.collideLineLine(t,o,e,i,r,l+c,r+n,l+c)),!!(y||d||u||s)&&(!p||x);
  ...
  for(var i=!1,r=0,l=0;l<e.length;l++){
    (r=l+1)===e.length&&(r=0);let n=e[l],c=e[r];(n.y>=o&&c.y<o||n.y<o&&c.y>=o)&&t<(c.x-n.x)*(o-n.y)/(c.y-n.y)+n.x&&(i=!i);
  }return i;
  ...
  void 0===r&&(r=!1);for(let l=0,n=0;n<i.length;n++){
    (l=n+1)===i.length&&(l=0);let c=i[n],p=i[l];if(this.collideLineCircle(c.x,c.y,p.x,p.y,t,o,e)){
      return!0;
    }
  ...
  null==l&&(l=!1);for(let n=0,c=0;c<r.length;c++){
    (n=c+1)===r.length&&(n=0);let p=r[c],y=r[n];if(this.collideLineRect(p.x,p.y,y.x,y.y,t,o,e,i)){
      return!0;
    }if(!0===l){
  ...
  for(let l=0,n=0;n<r.length;n++){
    (l=n+1)===r.length&&(l=0);let c=r[n].x,p=r[n].y,y=r[l].x,d=r[l].y;if(this.collideLineLine(t,o,e,i,c,p,y,d)){
      return!0;
    }
  }return!1;
  ...
  void 0===e&&(e=!1);for(let i=0,r=0;r<t.length;r++){
    (i=r+1)===t.length&&(i=0);let l=t[r],n=t[i],c=this.collideLinePoly(l.x,l.y,n.x,n.y,o);if(c){
      return!0;
    }if(!0===e){
  ...
  let p=this.abs((r-e)*(c-i)-(n-e)*(l-i));return this.abs((e-t)*(l-o)-(r-t)*(i-o))+this.abs((r-t)*(c-o)-(n-t)*(l-o))+this.abs((n-t)*(i-o)-(e-t)*(c-o))===p;
  ...
  void 0===c&&(c=0);let p=this.createVector(t,o),y=this.createVector(e,i),d=this.createVector(r,0).rotate(l),u=p.copy().sub(y);if(p.dist(y)<=r+c){
    let s=d.dot(u),x=d.angleBetween(u);if(s>0&&x<=n/2&&x>=-n/2){
      return!0;
    }
  }return!1;
